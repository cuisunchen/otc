<template>
  <div class="vue-ios-pickers">
    <div class="picker-value" @click="showPop()" style="display: none;">
    ...
    <transition name="picker" v-if="show">
      <div>
        ...
        <div class="picker-wrapper" key="wrapper">
          <div class="btn-box">
            <a class="pickerbtn btn-cancel" @click="onCancelHandler">{{$t('Text.cancel')}}</a>
            <a class="pickerbtn btn-confirm" @click="onConfirmHandler">{{$t('Publish.BalanceLimitBtn')}}</a>
          </div>
          <div class="data-box">
...
.data-box .scroll-mask {
  ...
  background-image: linear-gradient(180deg, #ffffff, rgba(255, 255, 255, 0.6)),
    linear-gradient(0deg, #ffffff, rgba(255, 255, 255, 0.6));
