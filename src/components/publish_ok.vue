<template>
  <div class="content-publish-ok">
    ...
    <div class="top-wrap">
      <img class="top-icon" src="../assets/image/publish_ok.png" />
      <div class="succee-hint">{{$t('Text.fbwtdcg')}}</div>
      <div class="bottom-hint">{{$t('Text.jycghhydxtz')}}</div>
    </div>

    <div class="btn-wrap">
      <mu-raised-button
        :label="$t('Text.goIndex')"
        @click="goBack"
        class="btn btn-border"
        primary
      />
      <mu-raised-button
        :label="$t('Trade.Publish.checkEntrust')"
        @click="checkEntrust"
...
@import "../assets/css/publish_ok.scss";
</style>
