<template>
  <div class="content">
    ...
    <div class="top">
      <div class="center">{{$t('Tab.Tab3Title')}}</div>
    </div>
    ...
    <div class="content-detail">
       ...
       <div class="p2_zone">
         <p class="p2">
          <span class="span-left">{{$t('Invite.BTC')}}</span> 
          <span class="span-right"><span>{{btc_qty}}</span>BTC</span>
         </p>
  ...
  beforeRouteEnter(to, from, next) {
    ...
    user
      ...
      .then(result => {
        ...
        let referral_code = 0;
        let invite_count = 0;
        let reward_summary = summary_result.reward_summary;
