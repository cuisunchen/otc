...
DarkTheme.prototype.__construct = function () {
  ...
  this._colors[Theme.Color.Background] = "#282a36";
  ...
  $(document).ready(function () {
    ...
    $('#chart_language_setting_div li a').click(function () {
      ...
      if ($(this).attr('name') == 'zh_cn') {
        chart_switch_language('zh_cn');
      } else if ($(this).attr('name') == 'en-us') {

        chart_switch_language('en-us');
      } else if ($(this).attr('name') == 'zh_tw') {
        chart_switch_language('zh_tw');
      }
    });
...
function readCookie() {
  ...
  chart_switch_language(tmp.language || "zh_cn");
}
...
var template_str = "\n" +
  ...
  "                        <ul>\n" +
  "                            <li style=\"height: 25px;\"><a name=\"zh_cn\" class=\"selected\">简体中文(zh_cn)</a></li>\n" +
  "                            <li style=\"height: 25px;\"><a name=\"en-us\">English(en-US)</a></li>\n" +
  "                            <li style=\"height: 25px;\"><a name=\"zh_tw\">繁體中文(zh-HK)</a></li>\n" +
  "                        </ul>\n" +
  "                    </div>\n" +
  "                </div>\n" +
